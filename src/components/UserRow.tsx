    ...
    return (
        <tr key={user.id}>
            ...
            <td className="border px-4 py-2">
                {user.jenisKelamin === "P" ? "Pria" : "Wanita"}
            </td>
            <td className="border px-4 py-2">{user.tanggalLahir}</td>
            <td className="border px-4 py-2">{user.tanggalInput}</td>
            <td className="border px-4 py-2 flex gap-2">
                <button
                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out"
                ...
                {isDeleting ? (
                    <button className="bg-gray-400 cursor-not-allowed text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
                        <BsTrashFill />
                    </button>
                ) : (
                    <button
